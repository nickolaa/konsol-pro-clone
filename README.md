...
#### 🔄 Задача 10: Система отзывов и рейтинга (Backend + Frontend)
**В процессе реализации:**
1. **Модель Review** (`backend/models.py`) - для хранения отзывов и оценок.
2. **ReviewSerializer** (`backend/serializers.py`) - API для работы с отзывами.
3. **ReviewViewSet** (`backend/views.py`) - логика создания и отображения отзывов.
4. **Рейтинг в профиле** - отображение среднего балла исполнителя.
